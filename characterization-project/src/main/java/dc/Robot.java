...
public class Robot extends TimedRobot {
  ...
  static private double GEARING = 10.0;
  ...
  public void robotInit() {
    ...
    CANSparkMax leftSlave0 = new CANSparkMax(14, MotorType.kBrushless);
    leftSlave0.follow(leftMaster);
    leftSlave0.setIdleMode(IdleMode.kBrake);

    CANSparkMax rightSlave0 = new CANSparkMax(1, MotorType.kBrushless);
